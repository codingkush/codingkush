...
# 💫 Kush Gupta – Full Stack Developer 👋
...
📈 Solved **500+ DSA problems** across platforms like **LeetCode, GeeksforGeeks, CodeStudio, etc.**  
...
**Frameworks & Libraries:** Spring Boot, ReactJS, Streamlit, Pandas, Matplotlib  
**Databases:** MongoDB, MySQL  
**Tools & Platforms:** Git, GitHub, Postman, Render, Streamlit Cloud  
**APIs & Services:** Gemini API, Razorpay API, Cloudinary  
...
[![](https://visitcount.itsvg.in/api?id=codingkush&icon=8&color=12)](https://visitcount.itsvg.in)

## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/mekushgupta) 
[![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/mekushgupta)
-->
